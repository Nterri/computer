...
const menuBody = document.querySelector('.header__items');
if (iconMenu) {
...
const finishCount = document.querySelector('.progress__all-finish');
const progress = document.querySelector('.progress');
const money = earned.textContent.slice(0, -1).split(' ').join('');
const finish = finishCount.textContent.slice(0, -1).split(' ').join('');
progress.style.width = `${money / finish * 100}%`;
